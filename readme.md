...
| `failureMessageOnly`       | JEST_HTML_REPORTERS_FAILURE_MESSAGE_ONLY        | number | 0                              | **0** : always create report.  **1** : show failure test suites messages only in Report.  **2** : only create report when some test suites failed.                                                                                                                                                                                                                                               |
